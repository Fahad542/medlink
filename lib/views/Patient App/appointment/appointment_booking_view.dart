...
class _AppointmentBookingViewState extends State<AppointmentBookingView> {
  ...
  Widget build(BuildContext context) {
    ...
    final dates = List.generate(14, (index) => DateTime.now().add(Duration(days: index)));
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      // Removed shadow for consistency
                    ),
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: GoogleFonts.inter(color: AppColors.primary, fontWeight: FontWeight.w600, fontSize: 14),
                              ),
                              const SizedBox(height: 6),
                              Row(
                                children: [
                                  ...
                                  Text("4.8 (120 Reviews)", style: GoogleFonts.inter(color: Colors.grey[600], fontSize: 12)),
                                ],
                              )
                            ],
                          ),
                         ...
                         builder: (_) => AlertDialog(
                           ...
                           content: Column(
                             ...
                             children: [
                               ...
                               const SizedBox(height: 20),
                               Text("Booking Confirmed!", style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 20)),
                               const SizedBox(height: 10),
                               Text(
                                 "You booked an appointment with ${widget.doctor.name} on ${DateFormat('MMM d').format(_selectedDate)} at $_selectedTime",
