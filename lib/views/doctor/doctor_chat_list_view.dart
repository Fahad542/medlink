    ...
    return Scaffold(
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final String patientName = index == 0 ? "John Doe" : (index == 1 ? "Jane Smith" : "Michael Brown");
          final String lastMessage = index == 0 ? "Dr. Alex, is the dosage correct?" : (index == 1 ? "Thanks for turn consultation." : "I have a mild fever again.");
          ...
          final String profileImage = index == 0 
              ...
              : (index == 1 ? "https://randomuser.me/api/portraits/women/2.jpg" : "https://randomuser.me/api/portraits/men/3.jpg");
                 ...
                 children: [
                   ...
                   if (isUnread) ...[
                     ...
                     Container(
                       ...
                       child: Text('1', style: GoogleFonts.inter(color: Colors.white, fontSize: 10)),
                     ),
                   ]
                 ],
               ),
