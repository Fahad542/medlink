class AppUrl {
  ...
  static const String getDoctorReviewsForPatient = '${baseUrl}/patient/doctors'; // /{doctorId}/reviews
  static const String bookAppointments = '${baseUrl}/patient/appointments';
  static const String getBookedSlots = '${baseUrl}/patient/doctors'; // /{id}/booked-slots
  ...
  static const String doctorCheckEmailAvailability = '${baseUrl}/auth/doctor/check-email';
  ...
  static const String getPrescriptionDetails = '${baseUrl}/doctor/appointments'; // /{id}/prescription-
  static const String updateDoctorPracticeSettings = '${baseUrl}/doctor/practice-settings';
  static const String updateDoctorAvailabilitySlots = '${baseUrl}/doctor/availability/slots';
  ...
  static const String doctorWithdrawalRequest = '${baseUrl}/doctor/withdrawals/request';
  ...
  static const String getDriverEmergencyRequests = '${baseUrl}/driver/emergency-requests';
  ...
  static const String getDriverEarningsSummary = '${baseUrl}/driver/earnings/summary';
  static const String getDriverEarningsTransactions = '${baseUrl}/driver/earnings/transactions';
  ...
  static const String driverWithdrawalRequest = '${baseUrl}/driver/withdrawals/request';
  // static const String baseUrl = 'https://www.medlink-africa.com';
  // // static const String baseUrl =
  // //     'http://192.168.0.101:3000'; // Emulator Magic IP (points to your machine)
  //
  ...
  // static const String getChatConversations = '${baseUrl}/chat/conversations';
  // static const String markChatConversationRead = '${baseUrl}/chat/conversations/read';
  // static const String uploadImage = '${baseUrl}/upload/image';
  ...
  static const String appointmentCheckout = '${baseUrl}/patient/appointments'; // /{id}/payment/checkout
  static const String confirmManualPayment = '${baseUrl}/patient/payments/confirm-manual';
  static const String reviewDoctor = '${baseUrl}/patient/appointments'; // /{appointmentId}/review-doctor
  static const String reviewDriver = '${baseUrl}/patient/trips'; // /{tripId}/review-driver
